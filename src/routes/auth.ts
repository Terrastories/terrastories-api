...
export async function authRoutes(fastify: FastifyInstance, options?: { database?: any }) {
  ...
  fastify.post('/auth/register', {
    schema: {
      description: 'Register a new user with password hashing and community association',
      tags: ['Authentication'],
      response: {
        201: {
  ...
  fastify.post('/auth/login', {
    ...
    try {
      ...
      const { passwordHash: _pw, createdAt: _ca, updatedAt: _ua, ...userResponse } = user;
